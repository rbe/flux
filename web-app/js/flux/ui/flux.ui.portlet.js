...
FLUX.UI.PORTLET = {
    ...
    renderPortlet: function(map) {
        ...
        // Title
        text += FLUX.UI.evalContent(map.title);
        ...
        text += FLUX.UI.evalContent(map.content);
    ...
    renderPortletContent: function(map) {
        ...
        if (!map.placement.toPortletId) map.placement.toPortletId = map.portletId;
        ...
        if (typeof(map.content) == "string" && map.content.match(/^http:\/\/.*/)) {
            ...
            map.placement.content = FLUX.UI.evalContent(map.content);
            FLUX.UI.placeContent(map.placement);
        }
    },
