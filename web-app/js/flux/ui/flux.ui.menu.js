...
FLUX.UI.MENU = {
    ...
    scripts: [
        FLUX.META.ADMINTASIA_URL + "/superfish.js",
    ],
    ...
    renderMenuItems: function(map) {
        ...
        for (i in map.items) {
            ...
            menuHtml += this.renderMenuItem(FLUX.TOOLS.merge({ menuItemId: i }, item));
    ...
    setMenuActions: function(map) {
        for (m in map) {
            ...
            for (i in menu.items) {
                ...
                var item2 = FLUX.TOOLS.merge({ menuItemId: i }, item);
