/*
 * JavaScript UI, based on Admintasia.
...
GLUE.UI = {
     ...
     */
    scripts: [
        GLUE.META.ADMINTASIA_URL + "/ui/ui.core.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.widget.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.mouse.js",
        GLUE.META.ADMINTASIA_URL + "/live_search.js",
        GLUE.META.ADMINTASIA_URL + "/tooltip.js",
        GLUE.META.ADMINTASIA_URL + "/cookie.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.sortable.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.draggable.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.resizable.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.position.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.button.js",
        GLUE.META.ADMINTASIA_URL + "/ui/ui.dialog.js",
        GLUE.META.GLUE_URL + "/glue.ui.menu.js",
        GLUE.META.GLUE_URL + "/glue.ui.message.js",
        GLUE.META.GLUE_URL + "/glue.ui.dialog.js",
        GLUE.META.GLUE_URL + "/glue.ui.widget.js",
        GLUE.META.GLUE_URL + "/glue.ui.portlet.js",
        GLUE.META.GLUE_URL + "/glue.ui.form.js"
    ],
    ...
    init: function(callback) {
        GLUE.loadScripts(this.scripts, 0, function() {
            ...
            GLUE.UI.WIDGET.hoverStaticWidgets();
            GLUE.UI.PORTLET.init();
    ...
    renderContent: function(where, content) {
        ...
        if (typeof(content) == "string" && content.match(/^http:\/\/.*/)) {
            ...
            where.text(GLUE.UI.evalContent(content));
        }
    },
    ...
    placeContent: function(map) {
        ...
        if (map.append) {
            var a = jQuery(map.append);
            var contained = a.has("#" + map.id);
            if (contained.length > 0) {
                jQuery("#" + map.id).html(map.content);
            } else {
                a.append(map.content);
            }
        }
        ...
        if (map.toPortletId) {
            var portlet = GLUE.UI.PORTLET.getPortlet(map.toPortletId);
            if (portlet) {
        ...
        if (map.toContentBoxId) {
            ...
            GLUE.UI.WIDGET.renderContentBoxContent(map);
        }
    },
